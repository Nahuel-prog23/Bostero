...
const fechas = [
  {
    fecha: "2024-05-11",
    partidos: [
      { equipoLocal: "Sarmiento", equipoVisitante: "I. Córdoba", gl: 1, gv: 2, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] }},
      { equipoLocal: "Argentinos Juniors", equipoVisitante: "Rosario Central", gl: 3, gv: 2, estadio: "Estadio Monumental" , goles: { local: [ { jugador: "Francisco Álvarez"},  {jugador: "Alan Lescano"},  {jugador: "Luciano Gondou"}], visitante: [ { jugador: "Agustín Módica"}, { jugador: "Leonardo Heredia"}] }},
      { equipoLocal: "Newell´s Old Boys", equipoVisitante: "Platense", gl: 2, gv: 0, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Jerónimo Cacciabue"}, { jugador: "Brian Aguirre"} ] } },
      { equipoLocal: "Huracán", equipoVisitante: "Defensa y Justicia", gl: 3, gv: 1, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Ignacio Pussetto"},  {jugador: "Héctor Fértoli"},  {jugador: "Héctor Fértoli"}], visitante: [ { jugador: "Gabriel Alanís"}] } },
      { equipoLocal: "Godoy Cruz", equipoVisitante: "Barracas Central", gl: 0, gv: 1, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] } },
      { equipoLocal: "Independiente", equipoVisitante: "Talleres", gl: 1, gv: 3, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Matías Catalán"} ], visitante: [ { jugador: "Federico Girotti"}, { jugador: "Marcos Portillo"}, { jugador: "Ramón Sosa"}] } },
      { equipoLocal: "River Plate", equipoVisitante: "Central Córdoba", gl: 3, gv: 0, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Facundo Colidio"} ] } },
      { equipoLocal: "Deportivo Riestra", equipoVisitante: "San Lorenzo de Almagro", gl: 1, gv: 0, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] } },
      { equipoLocal: "Tigre", equipoVisitante: "Estudiantes", gl: 0, gv: 1, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] } },
      { equipoLocal: "Belgrano", equipoVisitante: "Racing Club", gl: 4, gv: 4, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] } },
      { equipoLocal: "Lanús", equipoVisitante: "Independiente Rivad.", gl: 0, gv: 2, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] } },
      { equipoLocal: "At. Tucumán", equipoVisitante: "Boca Juniors", gl: 1, gv: 0, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] } },
      { equipoLocal: "Gimnasia La Plata", equipoVisitante: "Vélez Sarsfield", gl: 3, gv: 1, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] } },
      { equipoLocal: "Unión Santa Fe", equipoVisitante: "Banfield", gl: 1, gv: 0, estadio: "Estadio Monumental", goles: { local: [ { jugador: "Nicolás Dubersarsky"} ], visitante: [ { jugador: "Santiago Rodríguez"}, { jugador: "Santiago Rodríguez"}] } },
    ]
  },
  {
    fecha: "2024-05-18",
